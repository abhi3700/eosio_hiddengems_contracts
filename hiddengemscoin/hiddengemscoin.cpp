...
void hiddengemscoin::sub_balance( const name& owner, const asset& value ) {
...
void hiddengemscoin::add_balance( const name& owner, const asset& value, const name& ram_payer )
{
