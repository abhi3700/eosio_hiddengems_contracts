...
using std::string;
  ...
  */
CONTRACT hiddengemscoin : public contract {
  public:
     ...
     using create_action = eosio::action_wrapper<"create"_n, &hiddengemscoin::create>;
     using issue_action = eosio::action_wrapper<"issue"_n, &hiddengemscoin::issue>;
     using retire_action = eosio::action_wrapper<"retire"_n, &hiddengemscoin::retire>;
     using transfer_action = eosio::action_wrapper<"transfer"_n, &hiddengemscoin::transfer>;
     using open_action = eosio::action_wrapper<"open"_n, &hiddengemscoin::open>;
     using close_action = eosio::action_wrapper<"close"_n, &hiddengemscoin::close>;
  private:
